    ...
    private void handleAddSummary() {
        ...
        if (summaryTitle.isEmpty() || summaryContent.isEmpty()) {
            ...
            if (selectedCourse != null) {
                ...
                SummaryNotes sn= new SummaryNotes(summaryTitle, summaryContent, summaryTitle, summaryContent);
                try {
                    ResourcesInDb.addSummaryNotes(sn);
        ...
        try {
            ...
            // TODO: handle exception
            System.out.println("Can't go back to usertype.fxml");
        }
